<?php /* Smarty version Smarty-3.1.14, created on 2015-01-31 14:23:37
         compiled from "/home/action/workspace/www/themes/default-bootstrap/modules/blockcart/blockcart-json.tpl" */ ?>
<?php /*%%SmartyHeaderCode:45928853254cce569b05693-50380411%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8f6c619f5ebec3890a4bf177f412531678959cb8' => 
    array (
      0 => '/home/action/workspace/www/themes/default-bootstrap/modules/blockcart/blockcart-json.tpl',
      1 => 1395076666,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '45928853254cce569b05693-50380411',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54cce569cf3408_82569849',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54cce569cf3408_82569849')) {function content_54cce569cf3408_82569849($_smarty_tpl) {?>
{
"products": [
...
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode(ob_get_clean())?><?php }?>,
		"name": <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(html_entity_decode(trim($_smarty_tpl->tpl_vars['product']->value['name']),2,'UTF-8'),15,'...',true));?>
,
...
,
		"name": <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(trim((($_smarty_tpl->tpl_vars['discount']->value['name']).(' : ')).($_smarty_tpl->tpl_vars['discount']->value['description'])),18,'...'));?>
,
