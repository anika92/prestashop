<?php /* Smarty version Smarty-3.1.14, created on 2015-01-31 14:23:28
         compiled from "/home/action/workspace/www/admin/themes/default/template/helpers/list/list_content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:66159283154cce560a92271-41353770%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5c7f08c8be63df6c21a2d918c5b6d9c21646e671' => 
    array (
      0 => '/home/action/workspace/www/admin/themes/default/template/helpers/list/list_content.tpl',
      1 => 1395076664,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '66159283154cce560a92271-41353770',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54cce560e6d3f0_02172583',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54cce560e6d3f0_02172583')) {function content_54cce560e6d3f0_02172583($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/home/action/workspace/www/tools/smarty/plugins/modifier.regex_replace.php';
?>
<tbody>
					...
					<?php }elseif(isset($_smarty_tpl->tpl_vars['params']->value['position'])){?>
						<?php if ($_smarty_tpl->tpl_vars['order_by']->value=='position'&&$_smarty_tpl->tpl_vars['order_way']->value!='DESC'){?>
							<div class="dragGroup">
								...
								<div class="btn-group">
									<a class="btn btn-default btn-xs" href="<?php echo $_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['key']->value]['position_url_down'];?>
" <?php if (!($_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['key']->value]['position']!=$_smarty_tpl->tpl_vars['positions']->value[count($_smarty_tpl->tpl_vars['positions']->value)-1])){?>disabled<?php }?>>
										<i class="icon-chevron-<?php if ($_smarty_tpl->tpl_vars['order_way']->value=='ASC'){?>down<?php }else{ ?>up<?php }?>"></i>
									</a>
									<a class="btn btn-default btn-xs" href="<?php echo $_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['key']->value]['position_url_up'];?>
" <?php if (!($_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['key']->value]['position']!=$_smarty_tpl->tpl_vars['positions']->value[0])){?>disabled<?php }?>>
										<i class="icon-chevron-<?php if ($_smarty_tpl->tpl_vars['order_way']->value=='ASC'){?>up<?php }else{ ?>down<?php }?>"></i>
									</a>
								</div>
							</div>
						<?php }else{ ?>
